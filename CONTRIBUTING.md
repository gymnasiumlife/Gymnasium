Contributing to Gymnasium Core
============================

The Gymnasium Core project operates an open contributor model where anyone is
...
[good first issue](https://github.com/gymnasiumlife/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list.
...
include:
  ...
  - *qt* for changes to gymnasium-qt
...
[Translation Process](https://github.com/gymnasiumlife/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Gymnasium Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Gymnasium
Network Protocol consensus changes.

Whether a pull request is merged into Gymnasium Core rests with the project merge
...
Patches that change Gymnasium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Gymnasium consensus, it must have been
...
The review process is normally fairly responsive on the Gymnasium Core repository, however
...
Bitcoin Backports are an incredibly valuable part of Gymnasium's development. Backporting allows us to easily implement new
features, improvements and fixes as bitcoin implements them.

To see detailed statistics & progress see Google Sheet tracker: [Bitcoin backports for Gymnasium](https://docs.google.com/spreadsheets/d/1DnKxat0S0H62CJOzXpKGPXTa8hgoVOjGYZzoClmGSB8/edit?usp=sharing).
...
The project leader is the release manager for each Gymnasium Core release.
