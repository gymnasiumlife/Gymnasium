# Support for Output Descriptors in Gymnasium Core

Since Gymnasium Core v0.17, there is support for Output Descriptors. This is a
...
existing Gymnasium Core wallets, a convenience function `combo` is
...
All RPCs in Gymnasium Core will include the checksum in their output. Only
