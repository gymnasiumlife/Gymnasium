# Gymnasium Core version v19.2.0
...
At the first startup Gymnasium Core will run a migration process which can take
...
incompatible with older versions of Gymnasium Core, so a db migration path was
...
See detailed [set of changes](https://github.com/gymnasiumlife/compare/v19.1.0...gymnasiumpay:v19.2.0).
