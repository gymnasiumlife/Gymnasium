# Gymnasium Core version v19.3.0
...
- `wipetxes`: New command for `gymnasium-wallet` that removes all wallet transactions
...
See detailed [set of changes](https://github.com/gymnasiumlife/compare/v19.2.0...gymnasiumpay:v19.3.0).
