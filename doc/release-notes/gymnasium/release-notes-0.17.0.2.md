Gymnasium Core version 0.17.0.2
==========================
...
provided in [DIP-0020](https://github.com/gymnasiumpay/dips/blob/master/dip-0020.md).
...
from other quorum members. This allows Gymnasium Platform to obtain required
...
provided in [DIP-0021](https://github.com/gymnasiumpay/dips/blob/master/dip-0021.md).

Platform support
----------------
Support for Gymnasium Platform has been expanded through the addition of a new
...
BLS update
----------
Gymnasium Core’s BLS signature library has been updated based on v1.0 of the
Chia BLS library to support migration to a new BLS signature scheme which will
be implemented in a future version of Gymnasium. These changes will be made to
align with standards and improve security.

Network performance improvements
--------------------------------
This version of Gymnasium Core includes multiple optimizations to the network and
p2p message handling code.

We reintroduced [Intra-Quorum Connections](https://github.com/gymnasiumpay/dips/blob/master/dip-0006.md#intra-quorum-communication)
...
reliability. Activation of `SPORK_22_PS_MORE_PARTICIPANTS` in Gymnasium v0.16
...
Statoshi backport
------------------
This version includes a [backport](https://github.com/gymnasiumlife/pull/2515)
...
RPC changes
-----------
There are seven new RPC commands which are Gymnasium specific and seven new RPC
...
will be removed in Gymnasium v0.18. Note that the deprecation of wallet accounts
...
Gymnasium users. Bitcoin changes that do not align with Gymnasium’s product needs, such
...
See detailed [set of changes](https://github.com/gymnasiumlife/compare/v0.16.1.1...gymnasiumpay:v0.17.0.2).
