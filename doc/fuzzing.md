# Fuzzing Gymnasium Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Gymnasium Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
# libFuzzer" on https://github.com/gymnasiumlife/blob/develop/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/gymnasiumlife/blob/develop/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/gymnasiumlife/blob/develop/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/gymnasiumlife/tree/develop/src/test/fuzz).
...
Every single pull request submitted against the Gymnasium Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Gymnasium Core more robust.
...
with certain assembly code from Gymnasium Core's code. See [developer notes on sanitizers](https://github.com/gymnasiumlife/blob/develop/doc/developer-notes.md#sanitizers)
...
# Fuzzing Gymnasium Core using afl++

## Quickstart guide

To quickly get started fuzzing Gymnasium Core using [afl++](https://github.com/AFLplusplus/AFLplusplus):
...
# Fuzzing Gymnasium Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing Gymnasium Core using [Honggfuzz](https://github.com/google/honggfuzz):
