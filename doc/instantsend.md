...
This mechanism has been integrated into Bitcore-Node-Gymnasium which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gymnasiumpay/insight-api-gymnasium#web-socket-api](https://github.com/gymnasiumpay/insight-api-gymnasium#web-socket-api)
* API: [https://github.com/gymnasiumpay/insight-api-gymnasium#instantsend-transactions](https://github.com/gymnasiumpay/insight-api-gymnasium#instantsend-transactions)
