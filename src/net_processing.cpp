 ...
 *  We have 4 times smaller block times in Gymnasium, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        Gymnasium Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // GSM this code also handles non-TXs (Gymnasium specific messages)
