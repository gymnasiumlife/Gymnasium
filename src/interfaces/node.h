...
//! Interface for the src/evo part of a gymnasium node (gymnasiumd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a gymnasium node (gymnasiumd process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a gymnasium node (gymnasiumd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a gymnasium node (gymnasiumd process).
...
//! Top-level interface for a gymnasium node (gymnasiumd process).
class Node
{
public:
    virtual ~Node() {}
