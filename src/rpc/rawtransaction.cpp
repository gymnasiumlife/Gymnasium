                            ...
                            {RPCResult::Type::ARR, "vout", "",
                            {
                                {RPCResult::Type::OBJ, "", "",
                                {
                                    ...
                                    {RPCResult::Type::OBJ, "scriptPubKey", "",
                                    {
                                        ...
                                        {
                                            {RPCResult::Type::STR, "address", "gymnasium address"},
                                        }},
                                    }},
                                }},
                            }},
...
UniValue decodepsbt(const JSONRPCRequest& request)
{
    RPCHelpMan{"decodepsbt",
        "\nReturn a JSON object representing the serialized, base64-encoded partially signed Gymnasium transaction.\n",
        {
...
UniValue combinepsbt(const JSONRPCRequest& request)
{
    RPCHelpMan{"combinepsbt",
        "\nCombine multiple partially signed Gymnasium transactions into one transaction.\n"
