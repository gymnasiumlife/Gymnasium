...
static void masternode_list_help(const JSONRPCRequest& request)
{
    RPCHelpMan{"masternodelist",
        ...
        "  owneraddress   - Print the masternode owner Gymnasium address\n"
        "  payee          - Print the masternode payout Gymnasium address (can be additionally filtered,\n"
        "                   partial match)\n"
        "  pubKeyOperator - Print the masternode operator public key\n"
        "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
        "                   (can be additionally filtered, partial match)\n"
        "  votingaddress  - Print the masternode voting Gymnasium address\n",
        {
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    { "gymnasium",               "masternode",             &masternode,             {} },
    { "gymnasium",               "masternodelist",         &masternode,             {} },
};
// clang-format on
