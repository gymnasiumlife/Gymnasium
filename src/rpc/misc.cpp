...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"gymnasium\" activates all Gymnasium-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "gymnasium")
    + HelpExampleRpc("debug", "gymnasium+net")
    }}.Check(request);
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The gymnasium address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    RPCHelpMan{"verifymessage",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The gymnasium address to use for the signature."},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The difference of GymnasiumS"},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The number of GymnasiumS of the output"},
...
static UniValue getaddressbalance(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddressbalance",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
                {
                    {RPCResult::Type::NUM, "balance", "The current total balance in GymnasiumS"},
                    {RPCResult::Type::NUM, "balance_immature", "The current immature balance in GymnasiumS"},
                    {RPCResult::Type::NUM, "balance_spendable", "The current spendable balance in GymnasiumS"},
                    {RPCResult::Type::NUM, "received", "The total number of GymnasiumS received (including change)"},
                }},
        RPCExamples{
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "gymnasium-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Gymnasium features */
    { "gymnasium",               "mnsync",                 &mnsync,                 {} },
    { "gymnasium",               "spork",                  &spork,                  {"command"} },
    { "gymnasium",               "sporkupdate",            &sporkupdate,            {"name","value"} },
