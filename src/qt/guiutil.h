...
/** Utility functions used by the Gymnasium Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "gymnasium:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load gymnasium specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a gymnasium specific theme is activated (light/dark).*/
