...
BOOST_AUTO_TEST_CASE(addrman_select)
{
    ...
    CService addr3 = ResolveService("250.3.2.2", 17218);
    CService addr4 = ResolveService("250.3.3.3", 17218);
...
BOOST_AUTO_TEST_CASE(addrman_find)
{
    ...
    CAddress addr2 = CAddress(ResolveService("250.1.2.1", 17218), NODE_NONE);
...
BOOST_AUTO_TEST_CASE(addrman_getaddr)
{
    ...
    CAddress addr2 = CAddress(ResolveService("250.251.2.2", 17218), NODE_NONE);
...
BOOST_AUTO_TEST_CASE(caddrinfo_get_tried_bucket_legacy)
{
    ...
    CAddress addr2 = CAddress(ResolveService("250.1.1.1", 17218), NODE_NONE);
