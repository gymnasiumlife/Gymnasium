...
/* Initialize Gymnasium-specific components after chainstate initialization */
void GymnasiumTestSetup(NodeContext& node);
void GymnasiumTestSetupClose(NodeContext& node);
