# Bootstrappable Gymnasium Core Builds

This directory contains the files necessary to perform bootstrappable Gymnasium
Core builds.
...
To build Gymnasium Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Gymnasium Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/gymnasium-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/gymnasiumpay/guix.sigs).
...
[guix-docker]: https://github.com/gymnasiumlife/tree/master/contrib/guix/Dockerfile
