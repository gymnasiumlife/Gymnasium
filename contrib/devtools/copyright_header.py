...
EXPECTED_HOLDER_NAMES = [
    ...
    r"The Gymnasium Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a Gymnasium Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Gymnasium Core developers'
...
Arguments:
    <base_directory> - The base directory of Gymnasium Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Gymnasium Core repository.
"""
