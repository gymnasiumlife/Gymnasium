...
"""Verify that starting gymnasiumd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start gymnasiumd with -h for help text")
        ...
        self.log.info("Start gymnasiumd with -version for version information")
        ...
        self.log.info("Start gymnasiumdd with -fakearg to make sure it does not start")
