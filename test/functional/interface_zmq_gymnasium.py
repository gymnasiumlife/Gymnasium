...
"""Test the gymnasium specific ZMQ notification interfaces."""
...
from test_framework.test_framework import GymnasiumTestFramework
...
class GymnasiumZMQTest (GymnasiumTestFramework):
    def set_test_params(self):
        ...
        self.set_gymnasium_test_params(5, 4, fast_dip3_enforcement=True, extra_args=extra_args)
        self.set_gymnasium_llmq_test_params(4, 4)
    ...
    def run_test(self):
        self.subscribers = {}
        # Check that gymnasiumd has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all gymnasium related ZMQ publisher
